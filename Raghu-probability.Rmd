...
Exercise1.  What does a streak length of 1 mean, i.e. how many hits and misses are in a 
    streak of 1? 
    
    ANS: A hit followed by a miss.
    
    What about a streak length of 0?
    
    ANS:A miss followed by a miss.
...
Exercise2.  Describe the distribution of Kobe's streak lengths from the 2009 NBA finals. 
...
ANS: We can conclude that Kobe likely has a hot hand.
...
Exercise3.  In your simulation of flipping the unfair coin 100 times, how many flips 
    came up heads?
```{r E3, eval=TRUE}
sim_unfair_coin
...
Exercise4. What change needs to be made to the `sample` function so that it reflects a 
